...
int main(int argc, const char * argv[]) {
    ...
    std::cout << "Wlelcome to Justin's cpu scheduler from hell\n\n";
    ...
    for(size_t i = 0; i < 10; i++)
    {
        ...
        RRVector.push_back(Job(jobName, std::rand()%10 , std::rand()%5, std::rand()%10));
    ...
    avgRRTime = totalRRWaitTime/numProcesses;
